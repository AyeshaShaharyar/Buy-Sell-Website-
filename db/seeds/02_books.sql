...
(
    ...
    'Portable Pets',
    -- 'Lorella Rizzati',
    'https://covers.openlibrary.org/b/id/2646149-M.jpg',
    286,
    4,
...
(
    ...
    'Owl babies',
    -- 'Martin Waddell',
    'https://covers.openlibrary.org/b/id/6602047-M.jpg',
    119,
    2,
...
(
    ...
    'Johnny Lions book',
    -- 'Edith Thacher Hurd',
    'https://covers.openlibrary.org/b/id/51606-M.jpg',
    206,
    1,
...
(
    ...
    'Growing frogs',
    -- 'Vivian French',
    'https://covers.openlibrary.org/b/id/515082-M.jpg',
    87,
    5,
...
(
    ...
    'Pencil, paper, draw!',
    -- 'Steve Harpster',
    'https://covers.openlibrary.org/b/id/1738755-M.jpg',
    11,
    2,
...
(
    ...
    -- 'Eric Carle',
    'https://covers.openlibrary.org/b/id/11625175-M.jpg',
    249,
    3,
...
(
    'Happy Baby',
    -- 'Roger Priddy',
    'https://covers.openlibrary.org/b/id/2371344-M.jpg',
    83,
    5,
...
(
    ...
    -- 'Brian Wildsmith',
    'https://covers.openlibrary.org/b/id/4600916-M.jpg',
    90,
    4,
...
(
    'Lad, a dog',
    -- 'Margo Lundell',
    'https://covers.openlibrary.org/b/id/385802-M.jpg',
    161,
    2,
...
(
    ...
    -- 'Erica Silverman',
    'https://covers.openlibrary.org/b/id/11024980-M.jpg',
    216,
    4,
...
(
    ...
    -- 'H. G. Wells',
    'https://covers.openlibrary.org/b/id/431092-M.jpg',
    286,
    4,
    'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.',
    1,
    ...
    -- 'George Orwell',
    'https://covers.openlibrary.org/b/id/7898938-M.jpg',
    119,
    2,
    'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum. Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem. Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.',
    2,
    ...
    'The invisible man',
    -- 'H. G. Wells',
    'https://covers.openlibrary.org/b/id/8237011-M.jpg',
    206,
    1,
    'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus. Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis. Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.',
    3,
    ...
    'The time machine',
    -- 'H. G. Wells',
    'https://covers.openlibrary.org/b/id/230683-M.jpg',
    87,
    5,
    'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus. Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi. Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.',
    4,
    ...
    'Brave New World',
    -- 'Aldous Huxley',
    'https://covers.openlibrary.org/b/id/7894812-M.jpg',
    11,
    2,
    'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.',
    5,
...
(    'Empires of the plain',
    -- 'Lesley Adkins',
    'https://covers.openlibrary.org/b/id/7972506-M.jpg',
    286,
    4,
    'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.',
    1,
 ...
 (
    'Nuestra especie',
    -- 'Marvin Harris',
    'https://covers.openlibrary.org/b/id/9322618-M.jpg',
    119,
    2,
    'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum. Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem. Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.',
    2,
 ...
 (
    ...
    -- 'Michael Chazan',
    'https://covers.openlibrary.org/b/id/11746826-M.jpg',
    206,
    1,
    'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus. Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis. Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.',
    3,
 ...
 (
    'Ancient lives',
    -- 'Brian M. Fagan',
    'https://covers.openlibrary.org/b/id/191804-M.jpg',
    87,
    5,
    'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus. Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi. Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.',
    4,
...
(    'World History For Dummies',
    -- 'Peter Haugen',
    'https://covers.openlibrary.org/b/id/8400625-M.jpg',
    11,
    2,
    'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.',
    5,
